...
public class AviaSoulsTest {
    ...
    @Test
    public void testCompareToIfFirstPriceLess() {
    ...
    @Test
    public void testCompareToFirstPriceMore() {
    ...
    @Test
    public void testCompareToPriceEqual() {
    ...
    @Test
    public void testCompareToIfArrayByPrice() {
    ...
    @Test
    public void testCompareToIfAnotherArrayByPrice() {
    ...
    @Test
    public void testTicketTimeComparatorIfFirstPriceUnder() {
    ...
    @Test
    public void testTicketTimeComparatorIfFirstPriceMore() {
    ...
    @Test
    public void testTicketTimeComparatorIfFirstPriceEqual() {
    ...
    @Test
    public void shouldSearchAndSortByTimeButNotRoute() {
    ...
    @Test
    public void shouldSearchAndSortByTimeAnotherRoute() {
